...
public class conteo extends JFrame {
    ...
    public conteo() {
        ...
        center.add(spIn, BorderLayout.CENTER);
        ...
        // fila 1
        stats.add(new JLabel("Longitud del texto:"));
        lblLength = new JLabel();
        stats.add(lblLength);
        stats.add(new JLabel("Repeticiones de \"A\", \"a\" ó \"á\":"));
        lblCountA = new JLabel();
        stats.add(lblCountA);
        // fila 2
        stats.add(new JLabel("Total de palabras:"));
        lblWordCount = new JLabel();
        stats.add(lblWordCount);
        stats.add(new JLabel("Repeticiones de \"E\", \"e\" ó \"é\":"));
        lblCountE = new JLabel();
        stats.add(lblCountE);
        // fila 3
        stats.add(new JLabel("Primer letra del texto:"));
        lblFirstChar = new JLabel();
        stats.add(lblFirstChar);
        stats.add(new JLabel("Repeticiones de \"I\", \"i\" ó \"í\":"));
        lblCountI = new JLabel();
        stats.add(lblCountI);
        // fila 4
        stats.add(new JLabel("Última letra del texto:"));
        lblLastChar = new JLabel();
        stats.add(lblLastChar);
        stats.add(new JLabel("Repeticiones de \"O\", \"o\" ó \"ó\":"));
        lblCountO = new JLabel();
        stats.add(lblCountO);
        // fila 5
        stats.add(new JLabel("Letra central del texto:"));
        lblMiddleChar = new JLabel();
        stats.add(lblMiddleChar);
        stats.add(new JLabel("Repeticiones de \"U\", \"u\" ó \"ú\":"));
        lblCountU = new JLabel();
        stats.add(lblCountU);
        // fila 6
        stats.add(new JLabel("Primera palabra:"));
        lblFirstWord = new JLabel();
        stats.add(lblFirstWord);
        stats.add(new JLabel("Palabras con cantidad de caracteres par:"));
        lblEvenWords = new JLabel();
        stats.add(lblEvenWords);
        // fila 7
        stats.add(new JLabel("Palabra central:"));
        lblMiddleWord = new JLabel();
        stats.add(lblMiddleWord);
        stats.add(new JLabel("Palabras con cantidad de caracteres impar:"));
        lblOddWords = new JLabel();
        stats.add(lblOddWords);
        // fila 8
        stats.add(new JLabel("Última palabra:"));
        lblLastWord = new JLabel();
        stats.add(lblLastWord);
    ...
    private void openFile() {
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                String texto = Files.readString(currentFile.toPath());
    ...
    private void replaceText() {
        ...
        if (find != null) {
            ...
            if (replace != null) {
                String txt = inputArea.getText().replace(find, replace);
    ...
    private void processText() {
        ...
        // 4. Primera / Central / Última palabra
        ...
        // 5. Conteo de vocales acentuadas
        ...
        lblCountA.setText(String.valueOf(countA));
        lblCountE.setText(String.valueOf(countE));
        lblCountI.setText(String.valueOf(countI));
        lblCountO.setText(String.valueOf(countO));
        lblCountU.setText(String.valueOf(countU));
        // 6. Palabras pares / impares
        int even=0, odd=0;
        for (String w : words) {
            if ((w.length() % 2) == 0) even++;
            else odd++;
        }
        lblEvenWords.setText(String.valueOf(even));
        lblOddWords .setText(String.valueOf(odd));
        // 7. Traducción Murciélago
        StringBuilder sb = new StringBuilder();
        for (char c : txt.toCharArray()) {
            char lower = Character.toLowerCase(c);
            if (MURCIELAGO.containsKey(lower)) {
                sb.append(MURCIELAGO.get(lower));
            } else {
                sb.append(c);
            }
        }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(conteo::new);
    }
}